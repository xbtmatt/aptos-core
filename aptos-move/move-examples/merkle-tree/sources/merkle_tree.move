module package::merkle_tree {
   ...
   // TODO: add #[view] function that verifies proof, right now you can't because it passes in a &MerkleTree

	#[test]
	fun merkle_test_root_with_64k_leaves() {
