module mint_nft_v2_part4::whitelist {
    use std::vector;
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x60000, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50001, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50002, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50003, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50004, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50005, location = mint_nft_v2_part4::whitelist)]
    ...
    #[test(creator = @0xAA, account_a = @0xFA, account_b = @0xFB, account_c = @0xFC, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x10006, location = mint_nft_v2_part4::whitelist)]
