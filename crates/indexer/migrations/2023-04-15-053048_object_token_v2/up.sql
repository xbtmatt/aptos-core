...
CREATE TABLE IF NOT EXISTS collections_v2 (
  ...
  mutable_description BOOLEAN NOT NULL,
  mutable_uri BOOLEAN NOT NULL,
...
CREATE INDEX IF NOT EXISTS ta2_owner_type_index ON token_activities_v2 (owner_address, type);
...
CREATE INDEX IF NOT EXISTS ta2_cid_index ON token_activities_v2 (collection_id);
