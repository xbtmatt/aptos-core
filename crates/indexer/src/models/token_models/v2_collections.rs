...
pub struct CreatorFromCollectionTable {
...
impl CollectionV2 {
        ...
        if let Some(collection_data) = maybe_collection_data {
            ...
            Ok(Some((
                Self {
                    ...
                    max_supply: collection_data.maximum.clone(),
                    total_minted_v2: None,
                    mutable_uri: collection_data.mutability_config.uri,
                    mutable_description: collection_data.mutability_config.description,
                ...
                CurrentCollectionV2 {
                    ...
                    max_supply: collection_data.maximum,
                    total_minted_v2: None,
                    mutable_uri: collection_data.mutability_config.uri,
                    mutable_description: collection_data.mutability_config.description,
    ...
    pub fn get_by_table_handle(
        ...
        let mut res: Vec<Option<CreatorFromCollectionTable>> = sql_query(
